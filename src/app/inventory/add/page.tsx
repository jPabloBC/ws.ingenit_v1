...
export default function AddProductPage() {
  ...
  // Cargar categorías cuando cambie el storeType
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await createProduct(productData, user.id, storeType || undefined);
    ...
    <Layout>
      <div className="p-6">
        ...
        <CardContent>
          ...
          <div className="mb-8">
            <ProductSuggestions onProductSelect={handleProductFromApi} />
          </div>

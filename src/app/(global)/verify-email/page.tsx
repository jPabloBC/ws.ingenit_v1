    ...
    if (result.status === 'success' || result.status === 'already_verified') {
      if (result.hasBusiness) {
        ...
        return {
          text: 'Iniciar Sesión',
          href: '/login',
          description: 'Email verificado. Inicia sesión para continuar con la configuración del negocio.'
        };
      }
              ...
              {result.status === 'success' && (
                <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-md">
                  <p className="text-sm text-blue-700">
                    <strong>¡Email verificado exitosamente!</strong> Ahora regresa a la pantalla donde iniciaste tu registro para continuar con la configuración del negocio.
                  </p>
                </div>
              )}
              ...
              {result.status === 'already_verified' && (
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-md">
                  <p className="text-sm text-green-700">
                    <strong>Tu email ya estaba verificado.</strong> Regresa a la pantalla donde iniciaste tu registro para continuar.
                  </p>
                </div>
              )}
            </div>

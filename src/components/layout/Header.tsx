          ...
          {!isInRegistrationFlow && (
            <div className="hidden md:flex items-center space-x-4">
              {!isRegisterPage && (
                <Link href="/register">
                  <Button 
                    className="flex items-center bg-blue8 hover:bg-blue4 text-white text-base font-medium px-3 py-2 rounded-lg"
                  >
              ...
              {!isLoginPage && (
                <Link href="/login">
                  <Button 
                    variant="ghost" 
                    className="flex items-center text-gray2 bg-gray10 hover:bg-gray8 hover:border hover:border-gray11 hover:text-blue5 text-base font-medium px-3 py-2"
                  >
                ...
                <div className="space-y-3 pt-4 border-t border-blue13">
                  ...
                  {!isRegisterPage && (
                    <Link href="/register" className="block">
                      <Button 
                        className="w-full flex items-center justify-center bg-blue8 hover:bg-blue6 text-white text-base py-2 rounded-md"
                        onClick={() => setMobileMenuOpen(false)}
                      >
                        <User className="mr-2 h-4 w-4" />
                        Crear Cuenta

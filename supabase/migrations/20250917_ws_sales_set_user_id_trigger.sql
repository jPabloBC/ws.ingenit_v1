-- Migration: Ensure user_id is set from auth.uid() on insert into ws_sales
-- Date: 2025-09-17
...
BEGIN
  FOR rec IN
    ...
    WHERE c.relkind = 'r'
      ...
      AND c.relname = 'ws_sales'
  LOOP
    trig_name := 'trg_ensure_ws_sales_user_id';

    EXECUTE 'CREATE OR REPLACE FUNCTION '
      || quote_ident(rec.schemaname) || '.ensure_ws_sales_user_id() '

-- Script para agregar user_id a tablas existentes
...
-- 3. Crear tabla ws_usage si no existe
...
-- 4. Configurar RLS para las nuevas tablas
...
-- 6. Función para actualizar uso (corregida)
